...
public class LinkingEntityDistractorGeneratorTest {

	private LinkingEntityDistractorGenerator distractor;
	
	@Before
	public void init() {
		SparqlService.setEndpoint(Settings.DEFAULT_ENDPOINT_DBPEDIA);
		distractor = new LinkingEntityDistractorGenerator();
	}
	...
	public void generateBeginnerTest() {
		List<ResourceInfo> infos = distractor.generate(
				...
				SparqlService.queryResourceWithTypeHierachy("http://dbpedia.org/resource/Germany"), Difficulty.EXPERT, 11, 3);
